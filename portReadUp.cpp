...
//        printf("%x_%x_%d\n", recv_buf[0], recv_buf[1], rd_num);
        if(rd_num>0)
        {
            if(recv_buf[1] == 0x52 && dt==Angle_acce && recv_buf[10] != 0x55)
            {
            ...
            if(recv_buf[1] == 0x51 && dt == Acce && recv_buf[10] != 0x55)
            {
//                for(int i=0;i<11;i++)
//                {
//                    printf("%x\t", recv_buf[i]);
...
//                }
                ...
                //printf("%02X\t",(recv_buf[0] + recv_buf[1] + recv_buf[2] + recv_buf[3] + recv_buf[4] + recv_buf[5] +
                //recv_buf[6] + recv_buf[7] + recv_buf[8] + recv_buf[9])&255);

                //printf("%02X \t", recv_buf[10]&255);
                nCheck = recv_buf[10]&255;

                printf("%02X\t", nCheck);

                //toSum(recv_buf);
                //printf("%x\t",recv_buf[10]);
//                for(int i=0;i<10;i++)
//                {
//                   check += recv_buf[i];
//                }
